import { CTA, CheckList, Footer, Header, Hero, SectionHeading, VisualPanel } from "../components";
    ...
    <main>
      ...
      <section className="bg-white px-6 py-24">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.78fr_1fr] lg:items-center">
          <VisualPanel label="BR" title="Liderazgo visionario para soluciones biomédicas de alto estándar." />
          <div>
